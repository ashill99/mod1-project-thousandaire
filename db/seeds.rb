...
api_resp_medium = RestClient.get("https://opentdb.com/api.php?amount=50&difficulty=medium&type=multiple")
api_medium_data = JSON.parse(api_resp_medium)

api_resp_hard = RestClient.get("https://opentdb.com/api.php?amount=50&difficulty=hard&type=multiple")
api_hard_data = JSON.parse(api_resp_hard)
